...
Rectangle{
 ...
 Rectangle{anchors.left:parent.left;anchors.top:parent.top;anchors.margins:14;width:status.implicitWidth+20;height:32;radius:6;color:"#06111fcc"
  Label{id:status;anchors.centerIn:parent;text:"CAMERĂ FAȚĂ • "+video.status;color:video.playing?"#31d67b":"#f2f7fb";font.bold:true}}
 Button{anchors.right:parent.right;anchors.top:parent.top;anchors.margins:14;width:48;height:48;flat:true;ToolTip.visible:hovered;ToolTip.text:"Închide";contentItem:Label{text:"×";color:"white";font.pixelSize:32;font.bold:true;horizontalAlignment:Text.AlignHCenter;verticalAlignment:Text.AlignVCenter};onClicked:root.closed()}
